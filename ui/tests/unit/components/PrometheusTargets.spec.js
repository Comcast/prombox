...
describe("PrometheusTargets", () => {
  test("display targets", async () => {
    ...
    const wrapper = mount(PrometheusTargets, {
      localVue,
      store: mockStore
    });
    ...
    expect(wrapper.find("h1").text()).toBe("Targets");
    expect(wrapper.find("pre#targets").exists()).toBeTruthy();
    expect(wrapper.find("pre#targets").text()).toBe(
