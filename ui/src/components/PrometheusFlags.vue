...
<template>
  <div>
    <h1 class="font-semibold p-2">Command-Line Flags</h1>
    <pre id="flags" class="bg-gray-200 text-gray-900 text-sm border rounded p-2">{{ flags }}</pre>
  </div>
</template>
<script>
